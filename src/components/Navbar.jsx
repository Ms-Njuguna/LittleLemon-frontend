...
function Navbar() {
    ...
    return (
        <nav className="bg-[#EDEFEE] pt-4 pb-4 shadow-[0_4px_10px_rgba(0,0,0,0.05)] top-0 left-0 right-0 z-50">
            <div className="max-w-[1000px] mx-auto px-5 flex justify-between items-center"> {/* This is the new container */}
                {/* logo section */}
                <div>
                    <Link to="/">
