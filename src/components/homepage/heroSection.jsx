    ...
    return (
        <div className="relative bg-[rgb(73,94,87)] h-[400px] py-20"> {/* Removed 'overflow-hidden' */}
            ...
            <div className="absolute">
               <img src="src/assets/ui/bgPattern.png" alt="pattern" className="relative bottom-[80px] left-[130px] w-40 opacity-5"></img>
               <img src="src/assets/ui/bgPattern.png" alt="pattern" className="absolute top-30 left-12 w-40 opacity-5"></img>
            ...
            <div className="relative grid grid-cols-2 items-center max-w-[1000px] mx-auto my-[-20px] px-5 gap-[50px]"> {/* Changed to mx-auto px-5 */}
                <div>
                    ...
                    <h5 className="text-[#EDEFEE] text-[16px] font-semibold pb-4">Nairobi</h5>
                    ...
                    <button className="bg-[#F4CE14] px-4 py-2 rounded-[16px] mt-4 font-semibold text-[rgb(73,94,87)]">Reserve a table</button>
                </div>
                <div className="relative h-full"> {/* Made this container relative */}
                    <img src="src/assets/ui/restauranfood.jpg" alt="image of food" className="absolute my-[60px] right-[0px] top-1/2 -translate-y-1/2 h-[400px] w-[350px] rounded-[16px] object-cover"></img>
                </div>
            </div>
        </div>
    );
